...
from pointconv_util import PointConv, PointConvK, PointWarping, UpsampleFlow, CrossLayer
...
class SeparableBidirection(nn.Module):
    def __init__(self):
        super(SeparableBidirection, self).__init__()
        ...
        #l1: 2048
        self.level1 = PointConvK(2048, feat_nei, 64 + 3, 64)
        ...
        #l2: 512
        self.level2 = PointConvK(512, feat_nei, 128 + 3, 128)
        ...
        #l3: 256
        self.level3 = PointConvK(256, feat_nei, 256 + 3, 256)
        ...
        #l4: 64
        self.level4 = PointConvK(64, feat_nei, 512 + 3, 256)
